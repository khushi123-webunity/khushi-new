...
//------------------------------------------------------- without reload page add to cart item -----------------------------------------//
...
//-------------------------------------------------------------Add to cart button on popup-----------------------------------------//

const modal = document.querySelector("dialog")

document.querySelector(".popup-cart-button").addEventListener("click", () => {
  modal.showModal();
...
$(document).ready(function () { 
   $(document).on("click",".partytypebtn",function(){ 
      let _value = $(this).attr('data-value');
      $('[value="'+_value+'"]').prop("checked", true);
    }); 
  
 $(document).on("click","#nested-popup",function(e){ 
     e.preventDefault();
      let _value = $('[name="partytype"]:checked').val();
      var inputString = $("#quantity").val();
      window.location.href = "/collections/all/"+_value+"+"+inputString;
    }); 
}); 
...
//--------------------------------------------------------------- Upseller Product --------------------------------------------------------------//
 ...
 $(document).on('click','#radiono', function () {
      let getupsellid = $(this).parents('.upseller--image').find('#getupseller').val();
      let cartmsg = $(this);
      let formobj = {
        quantity: 1,
        id: getupsellid
